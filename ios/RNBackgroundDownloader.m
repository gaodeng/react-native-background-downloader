...
- (void)lazyInitSession {
    if (urlSession == nil) {
        NSString *bundleIdentifier = [[NSBundle mainBundle] bundleIdentifier];
        NSString *stringToAppend = [@".backgrounddownloadtask_" stringByAppendingString:[[NSUUID UUID] UUIDString]];
        NSString *sessonIdentifier = [bundleIdentifier stringByAppendingString:stringToAppend];
        NSURLSessionConfiguration *sessionConfig = [NSURLSessionConfiguration backgroundSessionConfigurationWithIdentifier:sessonIdentifier];
